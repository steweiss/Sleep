...
loadpackage(c("plyr","dplyr","ggplot2","knitr","broom","ggfortify","kableExtra","remotes","xts","eegUtils","dlm","forecast","signal","rmarkdown","plotly","visNetwork","Rssa","RHRV","data.table","DT","shinyTime","shinyWidgets","dygraphs","ggplotify","cowplot","tidyr","here"))
